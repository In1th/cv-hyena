...
<section class="relative flex flex-col content-center w-full  overflow-hidden">
    <div class="flex min-h-[90vh]">
        ...
        <div class="z-30 basis-1/2 flex flex-col pr-32 mb-40">
    ...
    <div class="absolute w-full h-full flex m-auto justify-center content-center ">
        <div class="border-primary h-[800px] aspect-square absolute z-0 border-8 border-dashed rounded-full animate-[spin_180s_linear_infinite]"></div>
        <div class="border-secondary border-t-4 w-[1000px] bottom-48 right-32 absolute z-10"></div>
        <div class="w-[300px] h-[100px] bottom-16 right-32 absolute z-10" id="box"></div>
